...
user_take = StringVar()
Label(root, text='choose any one: rock, paper ,scissors', font='arial 20 bold', bg ='seashell').place(x = 20, y = 20)
Entry(root, font = 'arial', textvariable=user_take, bg = 'antiquewhite2').place(x=90, y =130)
